 ...
 *           = File (영구적으로 저장)
 *           = RDBMS (관계형 데이터 베이스 ******) =>오라클 , 마리아디비 , MySQL => MongoDB
 *        ======================================================
 *        
 *        
 *     2. 연산자 / 제어문
 *        데이터 처리 (요철) => 가공
 *        연산자 : ++,--, ! (type) , 산술 연산자 , 비교연산자, 논리연산자 , 대입(=,+=,-=)
 ...
 *                                          for => arraycopy()
 *                                          
 *         데이터가 저장된 메모리마다 인덱스 번호를 부여한다. (0)
 *         int [] arr={10,20,30,40,50};
 *         
 *         배열 시작의 주소(주소를 참조해서 데이터 가지고 오기) ==> 참조형
...
//    ==================== Calendar
/*
 *    달력 => 1년 1월 1일 ~ 현재까지 총 날 수 구한다 ==> %7 => 요일 구한다.
 *    
 *    1. 전년도까지 합
 *    2. 전달까지 합
 *    3. 요청한 날짜까지
...
public class 자바기본문법 {
	...
	public static void main(String[] args) {
		...
		{
		case 0:
			System.out.printf("%d년 %d월 %d일은 일요일\n",year,month,day);
			break;
		case 1:
			System.out.printf("%d년 %d월 %d일은 월요일\n",year,month,day);
			break;
		case 2:
			System.out.printf("%d년 %d월 %d일은 화요일\n",year,month,day);
			break;
		case 3:
			System.out.printf("%d년 %d월 %d일은 수요일\n",year,month,day);
			break;
		case 4:
			System.out.printf("%d년 %d월 %d일은 목요일\n",year,month,day);
			break;
		case 5:
			System.out.printf("%d년 %d월 %d일은 금요일\n",year,month,day);
			break;
		case 6:
			System.out.printf("%d년 %d월 %d일은 토요일\n",year,month,day);
			break;
		}/*/
